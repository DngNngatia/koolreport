...
<div id="<?php echo $this->name; ?>" style="<?php echo Utility::get($this->css,"panel"); ?>" class="drilldown card <?php echo Utility::get($this->cssClass,"panel","bg-transparent");?>">
    <div style="<?php echo Utility::get($this->css,"header"); ?>" class="card-header <?php echo Utility::get($this->cssClass,"header");?>">
    ...
    <div class="card-body drilldown-body <?php echo Utility::get($this->cssClass,"body");?>" style="<?php echo Utility::get($this->css,"body"); ?>">
        <?php
