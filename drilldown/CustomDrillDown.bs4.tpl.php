...
<div id="<?php echo $this->name; ?>" style="<?php echo Utility::get($this->css,"panel"); ?>" class="custom-drilldown card <?php echo Utility::get($this->cssClass,"panel","bg-transparent"); ?>">
    <div class="card-header <?php echo Utility::get($this->cssClass,"header"); ?>">
    ...
    <div class="card-body custom-drilldown-body <?php echo Utility::get($this->cssClass,"body"); ?>" style="<?php echo Utility::get($this->css,"body"); ?>">
        <?php
