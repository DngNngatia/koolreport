...
?>
<div id="<?php echo $this->name; ?>" class="multiview card <?php echo Utility::get($this->cssClass,"panel","bg-transparent"); ?>" style="<?php echo Utility::get($this->css,"panel"); ?>">
    ...
    <div class="card-body multiview-body <?php echo Utility::get($this->cssClass,"body"); ?>" style="<?php echo Utility::get($this->css,"body"); ?>">
