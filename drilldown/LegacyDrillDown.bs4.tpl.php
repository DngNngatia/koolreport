...
<div id="<?php echo $this->name; ?>" style="<?php echo Utility::get($this->css,"panel"); ?>" class="legacy-drilldown card card-ascend-<?php echo $this->panelStyle; ?>">
    <div class="card-header">
        <div class="pull-right">
            ...
            {
            ?>
            <button style="<?php echo Utility::get($this->css,"btnBack"); ?>" type="button" onclick="<?php echo $this->name ?>.back()" class="btnBack <?php echo Utility::get($this->btnBack,"class","btn btn-sm btn-primary") ?>"><?php echo Utility::get($this->btnBack,"text","Back") ?></button>
            <?php    
            }
            ?>
        </div>
    ...
    <div class="card-body legacy-drilldown-body" style="<?php echo Utility::get($this->css,"body"); ?>">
        <?php
